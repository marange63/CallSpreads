...
## Architecture
- **Everything is in one file: `spx_call_spread_finder.py`** (~4000 lines). Pure stdlib `http.server`/`socketserver`; the three pages are hand-written HTML/CSS/JS held as big Python strings:
